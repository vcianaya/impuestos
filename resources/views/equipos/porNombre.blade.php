...
@section('cuerpo')
<div class="titulo">CONSULTA DE EQUIPO POR NOMBRE </div>
			<form  action="{{url('nombreEquipo')}}" method="post">
	        ...
	        <tr style="height: 50px;">
			   ...
			   <td width="100px">
			   	<input type="text" name="nom_equ"  class="txtselect short" style="width:200px;">
