...
@section('cuerpo')
<div class="titulo">CONSULTA DE USUARIOS POR NOMBRE </div>
			<form  action="{{url('UporNombre')}}" method="post">
	        ...
	        <tr style="height: 50px;">
			   ...
			   <td width="100px">
			   	<input type="text" name="nom_usu"  class="txtselect short" style="width:200px;">
